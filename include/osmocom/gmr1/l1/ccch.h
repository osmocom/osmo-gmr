...
#ifndef __OSMO_GMR1_L1_CCCH_H__
#define __OSMO_GMR1_L1_CCCH_H__

/*! \defgroup ccch CCCH (PCH/AGCH) channel coding
 *  \ingroup l1_chan
 *  @{
 */

/*! \file l1/ccch.h
 *  \brief Osmocom GMR-1 CCCH (PCH/AGCH) channel coding header
 */
